...
public abstract class CustomMatchers {
    ...
    public static Matcher<RecyclerView.ViewHolder> withKeyHolderId(final long keyId) {
        return new BoundedMatcher<RecyclerView.ViewHolder, org.sufficientlysecure.keychain.ui.util.recyclerview.item.KeyItem.ViewHolder>(org.sufficientlysecure.keychain.ui.util.recyclerview.item.KeyItem.ViewHolder.class) {
            ...
            @Override
            protected boolean matchesSafely(org.sufficientlysecure.keychain.ui.util.recyclerview.item.KeyItem.ViewHolder item) {
