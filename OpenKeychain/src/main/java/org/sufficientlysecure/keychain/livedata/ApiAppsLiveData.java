...
public class ApiAppsLiveData extends AsyncTaskLiveData<List<ListedApp>> {
    ...
    private static final ListedApp[] PLACERHOLDER_APPS = {
            ...
            new ListedApp("de.monocles.mail", false, false, "monocles mail", null, R.drawable.apps_monoclesmail),
            new ListedApp("de.monocles.chat", false, false, "monocles chat", null, R.drawable.apps_monocleschat),
