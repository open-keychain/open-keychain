...
public class KeyUpdateHelper {
    ...
    private class UpdateTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            for(String fprint : providerHelper.getAllFingerprintsForApp(KeychainContract.KeyRings.buildUnifiedKeyRingsUri())) {
                Log.d("fingerprint found", fprint);
