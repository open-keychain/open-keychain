...
public abstract class OperationResult implements Parcelable {
    ...
    public enum LogType {
        ...
        MSG_IP_ERROR_PASSPHRASE_CACHE (LogLevel.ERROR, R.string.msg_ip_error_passphrase_cache),
        ...
        MSG_IS_ERROR_MASTER_PASSPHRASE_ENCRYPT(LogLevel.DEBUG, R.string.msg_is_error_master_passphrase_encrypt),
        ...
        MSG_CU_ERROR_MERGE_KEYRING (LogLevel.ERROR, R.string.msg_op_error_merge_keyring),
        ...
        MSG_MF_REQUIRE_SUBKEY_PASSPHRASE(LogLevel.OK, R.string.msg_mf_require_subkey_passphrase),
        ...
        MSG_ED_REQUIRE_KEYRING_PASSPHRASE (LogLevel.OK, R.string.msg_ed_require_keyring_passphrase),
        MSG_ED_ERROR_KEY_NOT_FOUND (LogLevel.ERROR, R.string.msg_ed_error_key_not_found),
        MSG_ED_ERROR_KEYRING_NOT_FOUND (LogLevel.ERROR, R.string.msg_ed_error_keyring_not_found),
        MSG_ED_ERROR_DECRYPT_KEYRING(LogLevel.ERROR, R.string.msg_ed_error_decrypt_keyring),
        ...
        MSG_ED_ERROR_MERGE_KEYRING(LogLevel.ERROR, R.string.msg_op_error_merge_keyring),
        ...
        MSG_DC_ERROR_DECRYPT_KEYRING (LogLevel.ERROR, R.string.msg_dc_error_decrypt_keyring),
        ...
        MSG_DC_ERROR_UNLOCK_KEYRING (LogLevel.ERROR, R.string.msg_dc_error_unlock_keyring),
        MSG_DC_ERROR_UNLOCK_SUBKEY (LogLevel.ERROR, R.string.msg_dc_error_unlock_subkey),
        ...
        MSG_PSE_ERROR_DECRYPT_KEYRING (LogLevel.ERROR, R.string.msg_pse_error_decrypt_keyring),
        MSG_PSE_ERROR_MERGE_KEYRING (LogLevel.ERROR, R.string.msg_op_error_merge_keyring),
        ...
        MSG_PSE_ERROR_UNLOCK_SUBKEY(LogLevel.ERROR, R.string.msg_pse_error_unlock_subkey),
        MSG_PSE_ERROR_UNLOCK_KEYRING(LogLevel.ERROR, R.string.msg_pse_error_unlock_keyring),
        ...
        MSG_CRT_ERROR_MERGE_KEYRING(LogLevel.ERROR, R.string.msg_op_error_merge_keyring),
